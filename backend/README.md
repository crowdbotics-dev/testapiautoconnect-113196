...
## Project Structure
    ...
    ├── testapiautoconnect_113196  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_113196`
...
2. Clone this repo and `cd testapiautoconnect_113196`
